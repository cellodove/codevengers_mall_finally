...
<%
	...
	if(mem_id == null){  //로그인이 아니라면
		...
		login_check = "<a href='member_logout.jsp'>로그아웃</a>";
		member_register_check = "<a href='MemberInfo.do'>정보</a>";
	}
%>
  ...
  <div class="collapse navbar-collapse" id="#bs-example-navbar-collapse-1">
   ...
   <ul class="nav navbar-nav navbar-right">
    ...
    <li class="dropdown">
     ...
     <li><a href="member_itemlist.jsp">상품목록</a></li>
     <li><a href="member_wishlist.jsp">장바구니</a></li>
     <li><a href="member_orderlist.jsp">구매목록</a></li>
